    ...
    <div class="container">
      ...
      <section class="section product-details__section">
          ...
          <div class="product-detail__left">
            <div class="details__container--left">
              <div class="product__pictures">
                <div class="pictures__container">
                  <img class="picture" src="./images/products/jr/jr5.jpg" id="pic5" />
                </div>
                <div class="pictures__container">
                  <img class="picture" src="./images/products/jr/jr2.jpg" id="pic2" />
                </div>
                <div class="pictures__container">
                  <img class="picture" src="./images/products/jr/jr3.jpg" id="pic3" />
                </div>
                <div class="pictures__container">
                  <img class="picture" src="./images/products/jr/jr4.jpg" id="pic4" />
                </div>
                <div class="pictures__container">
                  <img class="picture" src="./images/products/jr/jr1.jpg" id="pic1" />
                </div>
              </div>
              <div class="product__picture" id="product__picture">
                <!-- <div class="rect" id="rect"></div> -->
                <div class="picture__container">
                  <img src="./images/products/jr/jr5.jpg" id="pic" />
                </div>
              </div>
            ...
            <div class="product-details__btn">
                  ...
                  <form action="butt1" method="Post">
                      <a href="#"><button type="submit" class="add" name="action" value="12">Add To Cart</button></a>
                      </form>
                  </span>
              <a class="buy" href="#">
                <span>
           ...
           <div class="product-detail__right">
            <div class="product-detail__content">
              ...
              <p>
                Jordan has always been a pretty popular brand with me! I love their
                 shoes! They are high quality made, stylish, and last forever!! 
                 Their shoes are also great! I love jordan
              </p>
        ...
        <div class="rate-score">
          ...
          data-spm-anchor-id="a2g0o.detail.0.i16.473c5fdbTooAad">jordan</span>
