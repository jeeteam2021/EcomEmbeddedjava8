                    ...
                    <form class="cart__form">
                            ...
                            <table width="100%" class="table">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="product__thumbnail">
                                            <a href="#">
                                                <img src="./images/products/vans/vans3.jpg" alt="">
                                            </a>
                                        </td>
                                        <td class="product__name">
                                            <a href="#">Vans</a>
                                            <br><br>
                                            <small>Black/36</small>
                                        </td>
                                ...
                                <tbody>
                                    <tr>
                                        <td class="product__thumbnail">
                                            <a href="#">
                                                <img src="./images/products/air/air3.jpg" alt="">
                                            </a>
                                        </td>
                                        <td class="product__name">
                                            <a href="#">Vans</a>
                                            <br><br>
                                            <small>Rouge/36</small>
                                        </td>
                                        <td class="product__price">
                                            <div class="price">
                        ...
                        <div class="cart__totals">
                            ...
                            <ul>
                                <li>
                                    Subtotal
                                    <span class="new__price">$322..97</span>
                                </li>
                                <li>
                                    Shipping
                                    <span>$7</span>
                                ...
                                <li>
                                    Total
                                    <span class="new__price">$329.97</span>
                                </li>
                            </ul>
