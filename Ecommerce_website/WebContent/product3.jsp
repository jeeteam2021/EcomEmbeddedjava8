    ...
    <div class="container">
      ...
      <section class="section product-details__section">
          ...
          <div class="product-detail__left">
            <div class="details__container--left">
              <div class="product__pictures">
                <div class="pictures__container">
                  <img class="picture" src="./images/products/air/air5.jpg" id="pic5" />
                </div>
                <div class="pictures__container">
                  <img class="picture" src="./images/products/air/air2.jpg" id="pic2" />
                </div>
                <div class="pictures__container">
                  <img class="picture" src="./images/products/air/air3.jpg" id="pic3" />
                </div>
                <div class="pictures__container">
                  <img class="picture" src="./images/products/air/air4.jpg" id="pic4" />
                </div>
                <div class="pictures__container">
                  <img class="picture" src="./images/products/air/air1.jpg" id="pic1" />
                </div>
              </div>
              <div class="product__picture" id="product__picture">
                <!-- <div class="rect" id="rect"></div> -->
                <div class="picture__container">
                  <img src="./images/products/air/air5.jpg" id="pic" />
                </div>
              </div>
           ...
           <div class="product-details__btn">
                  ...
                  <form action="butt1" method="Post">
                      <a href="#"><button type="submit" class="add" name="action" value="14">Add To Cart</button></a>
                      </form>
            ...
            <div class="product-detail__content">
              <h3>Nike</h3>
              <div class="price">
                <span class="new__price">$90.99</span>
              </div>
              ...
              <p>
                Nike has always been a pretty popular brand with me! I love their
                 shoes! They are high quality made, stylish, and last forever!! 
                 Their shoes are also great! I love nike
              </p>
        ...
        <div class="rate-score">
          ...
          data-spm-anchor-id="a2g0o.detail.0.i16.473c5fdbTooAad">Nike</span>
            ...
            <div class="glide__track" data-glide-el="track">
              <ul class="glide__slides latest-center">
                <li class="glide__slide">
                  <div class="product">
                    <div class="product__header">
                      <a href="#"><img src="./images/puma6.jpg" alt="product"></a>
                    </div>
                    <div class="product__footer">
