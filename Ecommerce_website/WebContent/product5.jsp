            ...
            <div class="details__container--left">
              <div class="product__pictures">
                <div class="pictures__container">
                  <img class="picture" src="./images/products/adidas/adidas5.jpg" id="pic5" />
                </div>
                <div class="pictures__container">
                  <img class="picture" src="./images/products/adidas/adidas2.jpg" id="pic2" />
                </div>
                <div class="pictures__container">
                  <img class="picture" src="./images/products/adidas/adidas3.jpg" id="pic3" />
                </div>
                <div class="pictures__container">
                  <img class="picture" src="./images/products/adidas/adidas4.jpg" id="pic4" />
                </div>
                <div class="pictures__container">
                  <img class="picture" src="./images/products/adidas/adidas1.jpg" id="pic1" />
                </div>
              </div>
              <div class="product__picture" id="product__picture">
                <!-- <div class="rect" id="rect"></div> -->
                <div class="picture__container">
                  <img src="./images/products/adidas/adidas5.jpg" id="pic" />
                </div>
              </div>
